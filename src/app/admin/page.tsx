  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Bienvenido al panel de control del sistema IRPC</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              <p className="font-medium text-gray-900">Gestionar Voluntarios</p>
              <p className="text-sm text-gray-600">Crear, editar o suspender</p>
            </div>
          </a>
          ...
          >
            ...
            <div>
              <p className="font-medium text-gray-900">Procesar Retiros</p>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-900">Panel en Desarrollo</h3>
            <p className="mt-2 text-sm text-blue-800">
              Este panel de administración está en construcción. Las páginas de gestión detallada 
              (voluntarios, productos, categorías, etc.) serán implementadas próximamente. Por ahora, 
              puedes ver las estadísticas generales del sistema.
            </p>
          </div>
        </div>
      </div>
