...
CREATE OR REPLACE FUNCTION "public"."add_product_and_price"("p_product_name" "text", "p_ean_code" "text", "p_country_id" bigint, "p_category_id" bigint, "p_establishment_id" bigint, "p_location_id" bigint, "p_price_value" numeric, "p_price_date" "date", "p_canonical_id" bigint DEFAULT NULL::bigint) RETURNS TABLE("product_id" bigint, "price_id" bigint)
...
ALTER FUNCTION "public"."add_product_and_price"("p_product_name" "text", "p_ean_code" "text", "p_country_id" bigint, "p_category_id" bigint, "p_establishment_id" bigint, "p_location_id" bigint, "p_price_value" numeric, "p_price_date" "date", "p_canonical_id" bigint) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."add_product_and_price"("p_product_name" "text", "p_ean_code" "text", "p_country_id" bigint, "p_category_id" bigint, "p_establishment_id" bigint, "p_location_id" bigint, "p_price_value" numeric, "p_price_date" "date", "p_user_id" "uuid" DEFAULT NULL::"uuid") RETURNS bigint
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."get_all_products_admin"("p_search" "text" DEFAULT NULL::"text", "p_limit" integer DEFAULT 50, "p_offset" integer DEFAULT 0) RETURNS TABLE("id" bigint, "name" "text", "category_name" "text", "image_url" "text", "is_active" boolean, "price_count" bigint, "last_update" "date")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."get_all_products_admin"("p_search" "text", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_products_to_scrape"("p_limit" integer DEFAULT 3) RETURNS TABLE("product_id" bigint, "ean_code" "text", "product_name" "text", "country_id" bigint, "category_id" bigint, "prices_count" bigint)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_products_to_scrape"("p_limit" integer) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."cpi_canonical_products" (
...
ALTER TABLE "public"."cpi_canonical_products" OWNER TO "postgres";


COMMENT ON TABLE "public"."cpi_canonical_products" IS 'Normalized product entities for comparing similar products across retailers';



ALTER TABLE "public"."cpi_canonical_products" ALTER COLUMN "canonical_id" ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME "public"."cpi_canonical_products_canonical_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."cpi_canonical_products"
    ADD CONSTRAINT "cpi_canonical_products_pkey" PRIMARY KEY ("canonical_id");
...
CREATE INDEX "idx_cpi_finances_user" ON "public"."cpi_finances" USING "btree" ("user_id", "date" DESC);
...
CREATE INDEX "idx_cpi_prices_product_date" ON "public"."cpi_prices" USING "btree" ("product_id", "date" DESC);
...
CREATE INDEX "idx_cpi_prices_user" ON "public"."cpi_prices" USING "btree" ("user_id");



CREATE INDEX "idx_cpi_products_canonical_id" ON "public"."cpi_products" USING "btree" ("canonical_id");
...
CREATE INDEX "idx_cpi_tracking_product" ON "public"."cpi_tracking" USING "btree" ("product_id");



CREATE INDEX "idx_cpi_tracking_user" ON "public"."cpi_tracking" USING "btree" ("user_id");
...
CREATE INDEX "idx_cpi_withdrawals_user" ON "public"."cpi_withdrawals" USING "btree" ("user_id");
...
ALTER TABLE ONLY "public"."cpi_canonical_products"
    ADD CONSTRAINT "cpi_canonical_products_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."cpi_categories"("category_id");
...
ALTER TABLE ONLY "public"."cpi_products"
    ADD CONSTRAINT "cpi_products_canonical_id_fkey" FOREIGN KEY ("canonical_id") REFERENCES "public"."cpi_canonical_products"("canonical_id");
...
CREATE POLICY "Admins can insert prices" ON "public"."cpi_prices" FOR INSERT WITH CHECK (("auth"."uid"() IN ( SELECT "cpi_users"."user_id"
   FROM "public"."cpi_users"
  WHERE ("cpi_users"."role" = 'admin'::"text"))));



CREATE POLICY "Admins can insert products" ON "public"."cpi_products" FOR INSERT WITH CHECK (("auth"."uid"() IN ( SELECT "cpi_users"."user_id"
   FROM "public"."cpi_users"
  WHERE ("cpi_users"."role" = 'admin'::"text"))));



CREATE POLICY "Admins can update products" ON "public"."cpi_products" FOR UPDATE USING (("auth"."uid"() IN ( SELECT "cpi_users"."user_id"
   FROM "public"."cpi_users"
  WHERE ("cpi_users"."role" = 'admin'::"text"))));
...
CREATE POLICY "Allow public read access on cpi_canonical_products" ON "public"."cpi_canonical_products" FOR SELECT USING (true);
...
CREATE POLICY "Allow public read access to cpi_categories" ON "public"."cpi_categories" FOR SELECT USING (true);



CREATE POLICY "Allow public read access to cpi_countries" ON "public"."cpi_countries" FOR SELECT USING (true);
...
CREATE POLICY "Allow public read access to cpi_establishments" ON "public"."cpi_establishments" FOR SELECT USING (true);
...
CREATE POLICY "Users can view their own profile" ON "public"."cpi_users" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
ALTER TABLE "public"."cpi_canonical_products" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."add_product_and_price"("p_product_name" "text", "p_ean_code" "text", "p_country_id" bigint, "p_category_id" bigint, "p_establishment_id" bigint, "p_location_id" bigint, "p_price_value" numeric, "p_price_date" "date", "p_canonical_id" bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."add_product_and_price"("p_product_name" "text", "p_ean_code" "text", "p_country_id" bigint, "p_category_id" bigint, "p_establishment_id" bigint, "p_location_id" bigint, "p_price_value" numeric, "p_price_date" "date", "p_canonical_id" bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_product_and_price"("p_product_name" "text", "p_ean_code" "text", "p_country_id" bigint, "p_category_id" bigint, "p_establishment_id" bigint, "p_location_id" bigint, "p_price_value" numeric, "p_price_date" "date", "p_canonical_id" bigint) TO "service_role";



GRANT ALL ON FUNCTION "public"."add_product_and_price"("p_product_name" "text", "p_ean_code" "text", "p_country_id" bigint, "p_category_id" bigint, "p_establishment_id" bigint, "p_location_id" bigint, "p_price_value" numeric, "p_price_date" "date", "p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."add_product_and_price"("p_product_name" "text", "p_ean_code" "text", "p_country_id" bigint, "p_category_id" bigint, "p_establishment_id" bigint, "p_location_id" bigint, "p_price_value" numeric, "p_price_date" "date", "p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_product_and_price"("p_product_name" "text", "p_ean_code" "text", "p_country_id" bigint, "p_category_id" bigint, "p_establishment_id" bigint, "p_location_id" bigint, "p_price_value" numeric, "p_price_date" "date", "p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_all_products_admin"("p_search" "text", "p_limit" integer, "p_offset" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_all_products_admin"("p_search" "text", "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_all_products_admin"("p_search" "text", "p_limit" integer, "p_offset" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_products_to_scrape"("p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_products_to_scrape"("p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_products_to_scrape"("p_limit" integer) TO "service_role";
...
GRANT ALL ON TABLE "public"."cpi_canonical_products" TO "anon";
GRANT ALL ON TABLE "public"."cpi_canonical_products" TO "authenticated";
GRANT ALL ON TABLE "public"."cpi_canonical_products" TO "service_role";



GRANT ALL ON SEQUENCE "public"."cpi_canonical_products_canonical_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."cpi_canonical_products_canonical_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."cpi_canonical_products_canonical_id_seq" TO "service_role";
